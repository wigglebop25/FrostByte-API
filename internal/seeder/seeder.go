...
func (s *Seeder) seedProducts() error {
	baseURL := "https://frostbytedata.blob.core.windows.net/products"
	...
	products := []struct {
	...
	}{
		{
			product: domain.Product{
				...
				Price:           8.50,
				ProductImageURI: fmt.Sprintf("%s/pork_gyoza.png", baseURL),
			},
		...
		},
		{
			product: domain.Product{
				...
				Price:           5.00,
				ProductImageURI: fmt.Sprintf("%s/edamame.png", baseURL),
			},
			categories: []string{"Zensai"},
		},
		{
			product: domain.Product{
				...
				Price:           11.00,
				ProductImageURI: fmt.Sprintf("%s/shrimp_tempura.png", baseURL),
			},
			categories: []string{"Zensai"},
		},
		{
			product: domain.Product{
				...
				Price:           12.00,
				ProductImageURI: fmt.Sprintf("%s/maguro_nigiri.png", baseURL),
			},
		...
		},
		{
			product: domain.Product{
				...
				Price:           9.50,
				ProductImageURI: fmt.Sprintf("%s/cali_roll.png", baseURL),
			},
			categories: []string{"Sushi & Sashimi"},
		},
		{
			product: domain.Product{
				...
				Price:           14.50,
				ProductImageURI: fmt.Sprintf("%s/salmon_sashimi.png", baseURL),
			},
			categories: []string{"Sushi & Sashimi"},
		},
		{
			product: domain.Product{
				...
				Price:           15.99,
				ProductImageURI: fmt.Sprintf("%s/tonkotsu_ramen.png", baseURL),
			},
		...
		},
		{
			product: domain.Product{
				...
				Price:           13.50,
				ProductImageURI: fmt.Sprintf("%s/tempura_udon.png", baseURL),
			},
			categories: []string{"Menrui"},
		},
		{
			product: domain.Product{
				...
				Price:           12.00,
				ProductImageURI: fmt.Sprintf("%s/yakisoba.png", baseURL),
			},
			categories: []string{"Menrui"},
		},
		{
			product: domain.Product{
				...
				Price:           12.50,
				ProductImageURI: fmt.Sprintf("%s/gyudon.png", baseURL),
			},
		...
		},
		{
			product: domain.Product{
				...
				Price:           13.50,
				ProductImageURI: fmt.Sprintf("%s/katsudon.png", baseURL),
			},
			categories: []string{"Donburi"},
		},
		{
			product: domain.Product{
				...
				Price:           21.00,
				ProductImageURI: fmt.Sprintf("%s/unagi_don.png", baseURL),
			},
			categories: []string{"Donburi"},
		},
		{
			product: domain.Product{
				...
				Price:           6.50,
				ProductImageURI: fmt.Sprintf("%s/matcha_mochi.png", baseURL),
			},
		...
		},
		{
			product: domain.Product{
				...
				Price:           7.00,
				ProductImageURI: fmt.Sprintf("%s/taiyaki.png", baseURL),
			},
			categories: []string{"Kanmi"},
		},
		{
			product: domain.Product{
				...
				Price:           5.50,
				ProductImageURI: fmt.Sprintf("%s/sesame_ice_cream.png", baseURL),
			},
			categories: []string{"Kanmi"},
		},
	}
